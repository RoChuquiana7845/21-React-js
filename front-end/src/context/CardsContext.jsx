...
import { getNameDeck, getInfoCard } from "../services/card.js";
...
export const CardsProvider = ({ children }) => {
  ...
  return (
    <cardContext.Provider value={{ isInit,cards, cardUser1, cardUser2, deck, user1points, user2points, user1CounterWin, user2CounterWin, nameDeck, getCard, Winner, Reiniciar, setIsInit }}>
      {children}
